...
typedef int yaml_read_handler_t(void *data, unsigned char *buffer, SIZE_T_MACRO size, SIZE_T_MACRO *size_read);
...
YAML_DECLARE(void)
yaml_parser_set_input_file(yaml_parser_t *parser, void *file);
...
typedef int yaml_write_handler_t(void *data, unsigned char *buffer, SIZE_T_MACRO size);
...
typedef struct yaml_emitter_s
{
    ...
    struct
    {
        ...
        SIZE_T_MACRO handle_length;
        /** The tag suffix. */
        yaml_char_t *suffix;
        /** The tag suffix length. */
        SIZE_T_MACRO suffix_length;
    } tag_data;
...
YAML_DECLARE(void)
yaml_emitter_set_output_string(yaml_emitter_t *emitter, unsigned char *output, SIZE_T_MACRO size,
                                SIZE_T_MACRO *size_written);
...
YAML_DECLARE(void)
yaml_emitter_set_output_file(yaml_emitter_t *emitter, void *file);
